/* PSGrooPIC SRC V1.8a nBTL SRC */
/* 1.9 Custom PL3 payload by Kakaroto ported to PIC
/* 1.8a Custom v4 payload by Hermes ported to PIC
/* 1.8 Custom v3 payload by Hermes and payload by Waninkoko ported to PIC
/* 1.7 Custom v3 payload by Hermes ported to PIC
/* 1.6 Custom payload v2 payload by Hermes and payload by Waninkoko ported to PIC
/* 1.5 Custom payload by Hermes ported to PIC
