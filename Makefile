...
all:
		...
		$(B2HTARGET) $(PAYLOAD_DIR)/$(DEF_PAYLOAD)_$(FIRMWARE_3_40).bin $(PAYLOAD_DIR)/$(DEF_PAYLOAD)_pic_$(FIRMWARE_3_40).h $(DEF_PAYLOAD)_$(FIRMWARE_3_40)
		...
		$(B2HTARGET) $(PAYLOAD_DIR)/$(DEV_PAYLOAD)_$(FIRMWARE_3_40).bin $(PAYLOAD_DIR)/$(DEV_PAYLOAD)_pic_$(FIRMWARE_3_40).h $(DEV_PAYLOAD)_$(FIRMWARE_3_40)
		...
		$(B2HTARGET) $(PAYLOAD_DIR)/$(NUS_PAYLOAD)_$(FIRMWARE_3_40).bin $(PAYLOAD_DIR)/$(NUS_PAYLOAD)_pic_$(FIRMWARE_3_40).h $(NUS_PAYLOAD)_$(FIRMWARE_3_40)
		...
		$(CCS_COMPILER) $(CCS_FLAGS_WBL) $(CCS_FLAGS_LEDS) $(CCS_FLAGS_DEF_PAYLOAD) +GFW340="true" $(CCS_SOURCE)
		...
		$(CCS_COMPILER) $(CCS_FLAGS_WBL) $(CCS_FLAGS_LEDS) $(CCS_FLAGS_DEV_PAYLOAD) +GFW340="true" $(CCS_SOURCE)
		...
		$(CCS_COMPILER) $(CCS_FLAGS_WBL) $(CCS_FLAGS_LEDS) $(CCS_FLAGS_NUS_PAYLOAD) +GFW340="true" $(CCS_SOURCE)
		...
		$(CCS_COMPILER) $(CCS_FLAGS_NBL) $(CCS_FLAGS_LEDS) $(CCS_FLAGS_DEF_PAYLOAD) +GFW340="true" $(CCS_SOURCE)
		...
		$(CCS_COMPILER) $(CCS_FLAGS_NBL) $(CCS_FLAGS_LEDS) $(CCS_FLAGS_DEV_PAYLOAD) +GFW340="true" $(CCS_SOURCE)
		...
		$(CCS_COMPILER) $(CCS_FLAGS_NBL) $(CCS_FLAGS_LEDS) $(CCS_FLAGS_NUS_PAYLOAD) +GFW340="true" $(CCS_SOURCE)
